 ...
 */
@Component
public class JcZqSPFCheckHandler implements JjGameCheckHandler{
	...
	public Integer getGameId() {
		return GameType.JJ_ZC_SPF.getIndex();
	}

	@Override
	public ModelResult<TjplanCheckResult> checkPlanItem(List<TjPlanItem> tjPlanItem) {
//		110212302(1-1.3)
		String regex = "^\\d{9}\\(\\d+\\-\\d\\.{0,1}\\d{0,4}(,\\d+\\-\\d\\.{0,1}\\d{0,4}){0,1}\\)$";
	...
	public static void main(String[] args){
		...
		System.out.println(pattern.matcher("110212302(1-1.3)").find());
	}
